...
# to set the width and height of game window 
SCREEN_WIDTH = 400
SCREEN_HEIGHT = 400

# to set background color of game window 
white = (255, 255, 255)
...
# this is used to track the time
CLOCK = pg.time.Clock()

# this method is to build the infrastructure of the display
screen = pg.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT + 100), 0, 32)

# setting up a nametag for the game window
pg.display.set_caption("My Tic Tac Toe")

#  loading the images as python project
initiating_window = pg.image.load("TTTCoverart.png")
x_img = pg.image.load("X.png")
y_img = pg.image.load("o.png")

# resizing images
initiating_window = pg.transform.scale(
    initiating_window, (SCREEN_WIDTH, SCREEN_HEIGHT + 100))
...
def game_initiating_window():
    ...
    pg.draw.line(screen, line_color, (SCREEN_WIDTH / 3, 0), (SCREEN_WIDTH / 3, SCREEN_HEIGHT), 7)
    pg.draw.line(screen, line_color, (SCREEN_WIDTH / 3 * 2, 0),
                 (SCREEN_WIDTH / 3 * 2, SCREEN_HEIGHT), 7)
    
    
    # drawing horizontal lines
    pg.draw.line(screen, line_color, (0, SCREEN_HEIGHT / 3), (SCREEN_WIDTH, SCREEN_HEIGHT / 3), 7)
    pg.draw.line(screen, line_color, (0, SCREEN_HEIGHT / 3 * 2),
...
def draw_status():
        ...
        #getting the gloabal variable draw into action
    global draw
...
# copy the rendered message onto the board creating a small block at the bottom of the display 
    ...
    for row in range(0, 3):
        if((board[row][0] == board[row][1] == board[row][2]) and (board[row][0] is not None)):
            ...
            pg.draw.line(screen, (250, 0, 0),
                         ...
                         (SCREEN_WIDTH, (row + 1)*SCREEN_HEIGHT / 3 - SCREEN_HEIGHT / 6),
                         4)
            break
...
def drawXO(row, col):
    ...
    if(XO == 'x'):
        ...
        # pasting x_img over the screen at a coordinate position of (pos_y, pos_x) defined in the code above
